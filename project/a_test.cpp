	...
	while (mark == 0){
		...
		if (rec_init[0] - 1>=0){
			if (matrix[rec_init[0] - 1][rec_init[1]] == rec_len){//left value==current value?
                ...
                delay();
                delay();
				//drawline(100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 55., 100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 105.);
		...
		if (rec_init[0] + 1<=2*num){
			if (matrix[rec_init[0] + 1][rec_init[1]] == rec_len){//right value==current value?
                ...
                delay();
                delay();
				//drawline((100 * (rec_init[0]) - 2)/2 + 50., 100 * (rec_init[1]) / 2 + 1 * row + 5., (100 * (rec_init[0]) - 2)/2 + 100., 100 * (rec_init[1]) / 2 + 1 * row + 5.);
				//drawline(100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 55., 100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 105.);
		...
		if (rec_init[1] + 1<=2*num){
			if (matrix[rec_init[0]][rec_init[1] + 1] == rec_len){//above value==current value?
                ...
                delay();
				//drawline(100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 55., 100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 105.);
				//drawline((100 * (rec_init[0]) - 2) + 50., 100 * (rec_init[1]) / 2 + 1 * row + 5., (100 * (rec_init[0]) - 2) + 100., 100 * (rec_init[1]) / 2 + 1 * row + 5.);
		...
		if (rec_init[1] - 1>=0){
			if (matrix[rec_init[0]][rec_init[1] - 1] == rec_len){//below value==current value?
                ...
                delay();
                delay();
				//drawline((100 * ((rec_init[0]) - 2) / 2 + 1) + 50., 100 * (num - (rec_init[1]) / 2) + 1 * row + 5., (100 * ((rec_init[0]) - 2) / 2 + 1) + 50., 100 * (num - (rec_init[1]) / 2) + 1 * row + 5.);
				//drawline((100 * ((rec_init[0]) - 2) / 2 + 1) + 50., 100 * (rec_init[1]) / 2 + 1 * row + 5., (100 * ((rec_init[0]) - 2) / 2 + 1) + 100., 100 * (rec_init[1]) / 2 + 1 * row + 5.);
				//drawline(100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 55., 100 * (rec_init[0] - 2) / 2 + 1 * row + 5., 100 * rec_init[1] / 2 + 105.);
				//drawline((100 * (rec_init[0]) - 2) + 50., 100 * (rec_init[1]) / 2 + 1 * row + 5., (100 * (rec_init[0]) - 2) + 100., 100 * (rec_init[1]) / 2 + 1 * row + 5.);
